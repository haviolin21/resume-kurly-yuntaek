  ...
  const projectData = {
    ko: {
      ivr: {
        ...
        labels: { p: "문제 정의", h: "가설 설정", e: "실행 전략", r: "성과 및 수치" }
      },
      pay: {
    ...
    en: {
      ivr: {
        ...
        tools: "SQL, IVR Scenario Design, User Interview",
        labels: { p: "Problem", h: "Hypothesis", e: "Execution", r: "Result" }
      },
      pay: {
  ...
  const openModal = (projectId) => {
    ...
    modalContent.innerHTML = `
      ...
      <div class="detail-section">
        <h4>${data.labels.p} (Problem)</h4>
        <p>${data.problem}</p>
      </div>
      
      <div class="detail-section">
        <h4>${data.labels.h} (Hypothesis)</h4>
        <p>${data.hypothesis}</p>
      </div>
      
      <div class="detail-section">
        <h4>${data.labels.e} (Execution)</h4>
        <p>${data.execution}</p>
      </div>
      
      <div class="detail-section">
        <h4>${data.labels.r} (Result)</h4>
        <p>${data.result}</p>
      </div>
